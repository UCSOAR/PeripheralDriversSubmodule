...
void TMUX1104Driver::Enable(){
	//turns on enable for circuit (~EN pin)
...
void TMUX1104Driver::Select(Camera cam){
	// note that on the hardware a0 and a1 are switched. the .ioc naming is consistent with altium, so they are reversed in software here.
	switch(cam){
	case Camera::CAMERA1:

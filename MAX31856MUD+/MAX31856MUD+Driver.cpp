#include <assert.h>
#include <MAX31856MUD+/MAX31856MUD+Driver.hpp>
...
float MAX31856Driver::ReadThermocoupleTempC() {
    ...
    // Force single-byte reads for each register
    buf[0] = GetRegister(MAX31856_REG::LTCBH);
    buf[1] = GetRegister(MAX31856_REG::LTCBM);
    buf[2] = GetRegister(MAX31856_REG::LTCBL);
